#!/usr/bin/env nu
# Description:
#   This script is used to test the Docker image of nushell officially released binaries.
# Usage:
#   Change to the directory where the Dockerfile is located and run:
#   docker run -it --rm -v $"(pwd):/work" hustcer/nushell:latest-alpine /work/test-docker.nu
#   docker run -it --rm -v $"(pwd):/work" hustcer/nushell:latest-bookworm /work/test-docker.nu
